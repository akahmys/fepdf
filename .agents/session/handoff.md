...
- **Rule Integration**: Updated `.agents/rules/pipeline.md` with handle stability and PUA preservation principles.
...
## 2. Current State
- **Build Health**: Entire `fepdf-model` and `fepdf-sdk` suites compile cleanly.
