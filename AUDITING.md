...
**Twenty-seven steps**, in the order the script runs them. Derive this list rather than
...
| 25 | `cargo fmt --all --check` | 19 |
| 26 | `cargo deny check licenses` | 16 |
| 27 | `betterleaks dir .` | 18 |
