...
**Twenty-four steps**, in the order the script runs them. Derive this list rather than
...
| 22 | `cargo fmt --all --check` | 19 |
| 23 | `cargo deny check licenses` | 16 |
| 24 | `betterleaks dir .` | 18 |
