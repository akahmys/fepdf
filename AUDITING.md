...
**Twenty-five steps**, in the order the script runs them. Derive this list rather than
...
| 23 | `cargo fmt --all --check` | 19 |
| 24 | `cargo deny check licenses` | 16 |
| 25 | `betterleaks dir .` | 18 |
