...
| | |
| :--- | :--- |
| **Write anything but AES-256** | It reads every password-based scheme the standard defines — RC4, AES-128, AES-256 — and writes one: AES-256 at revision 6, with `--encrypt-password`. Output is always PDF 2.0, and that edition deprecates the rest ([ADR-0015](docs/adr/0015-this-engine-reads-five-encryption-schemes-and-writes-one.md)). |
