//! PDF Font Dictionary Schemas (ISO 32000-2:2020 Clause 9)

use fepdf_core::handle::Handle;
use fepdf_core::{FromPdfObject, Object, PdfName};
...
pub struct PdfFontDescriptor {
    ...
    pub font_bbox: fepdf_core::graphics::Rect,
    #[pdf_key("ItalicAngle")]
...
pub struct PdfType0Font {
    ...
    pub descendant_fonts: Handle<Vec<Object>>,
}
