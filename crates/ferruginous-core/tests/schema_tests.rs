...
use ferruginous_core::PdfArena;
use ferruginous_core::font::schema::PdfFont;
use ferruginous_core::graphics::schema::PdfExtGState;
use ferruginous_core::object::{FromPdfObject, PdfSchema};
...
fn test_graphics_schema_expansion() {
    ...
    assert_eq!(gs.blend_mode, Some(ferruginous_core::graphics::BlendMode::Multiply));
